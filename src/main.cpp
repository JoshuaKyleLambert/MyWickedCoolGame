...
// configuration step. It creates a namespace called `MyWickedCoolGame`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        MyWickedCoolGame::cmake::project_name,
        MyWickedCoolGame::cmake::project_version));// version string, acquired
